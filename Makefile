...
parser: lex.yy.c grammar.tab.o Nodes.o main.cc
	g++ $(FLAGS) -oparser grammar.tab.o Nodes.o lex.yy.c main.cc
...
lex.yy.c: lexer.ll grammar.tab.cc
	flex lexer.ll
clean:
	rm -f grammar.tab.* lex.yy.c* parser tree.pdf grammar.output graph.dot *.o
